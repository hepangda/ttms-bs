...
export default class FilterTable extends Component {
  ...
  handleRemove = (value, index, record) => {
    ...
    axios.delete("http://127.0.0.1:8080/api/movie", {
      data: {
        type: "Delete",
        movie: {
    ...
    return (
      <div className="filter-table-operation" style={styles.filterTableOperation}>
        <span>
          ...
          <AddSchedule index={index} record={record} getFormValues={this.getFormValues} />
        </span>
      </div>
    );
  };
